...
<body>
  ...
  <table cellspacing="0" cellpadding="3" border="0" width="100%">
    ...
    <tr>
      <td align="left" colspan="5" style="border-top: 1px solid black;font-size: 12px;">
        Terbilang: <b><?php echo terbilang(($purchase->total_harga_po + $purchase->total_pajak_po) - $purchase->total_diskon_po); ?></b>
      </td>
  ...
  <table cellspacing="0" cellpadding="0" style="margin-top: 10px;" border="0" width="100%">
   ...
   <!-- <p align="right" style="vertical-align: text-top;margin:0;padding: 0;">Bekasi, <?php echo date("d-m-Y") ?></p>
    ...
    <tr>
      <td valign="top" colspan="2" style="font-size: 12px;">
        <p align="left" style="vertical-align: text-top;margin:0;padding: 0;"><u>(Yuki I. S.)</u></p>
