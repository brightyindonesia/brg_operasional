            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group"><label>Nama Produk (*)</label>
                  <?php echo form_dropdown('produk', $get_all_produk, '', $produk_nama); ?>
                </div>
              </div>
  ...
  <script>
    ...
    $('#btn-simpan').click(function(e){
        ...
        if (keys == '') {
          ...
          $.ajax({ 
              url:"<?php echo base_url()?>admin/keyword/produk_tambah_proses",
              method:"post",
              dataType: 'JSON', 
              data:{keys: keys, produk:produk, [csrfName]: csrfHash},
