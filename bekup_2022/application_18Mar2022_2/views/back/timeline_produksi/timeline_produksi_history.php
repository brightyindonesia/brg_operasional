      ...
      <div class="box box-primary">
        ...
        ?>
          <div class="box-header">
            <a href="<?php echo base_url('admin/timeline_produksi/stok_pabrik/'.base64_encode($timeline->no_timeline_produksi)); ?>" class="btn btn-success"><i class="fa fa-cubes" style="margin-right: 5px;"></i> Stok Bahan Kemas di Pabrik</a>  
          </div>
                ...
                <tbody>
                  <?php $no = 1; foreach($detail as $data){
                    ...
                    if ($data->id_jenis_timeline == 1) {
                      ...
                      $edit = '<a href="'.base_url('admin/timeline_produksi/edit_info/'.base64_encode($data->id_detail_timeline_produksi)).'" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>';
                      ...
                      $edit = '<a href="'.base_url('admin/timeline_produksi/edit_industry/'.base64_encode($data->id_detail_timeline_produksi).'/'.base64_encode($data->no_timeline_produksi)).'" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>';
                      ...
                      if ($cek_posi == 0) {
                        ...
                        $edit = '<a href="'.base_url('admin/timeline_produksi/edit_posi_delivery/'.base64_encode($data->id_detail_timeline_produksi)).'" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>';
                      }
                      ...
                      $edit = '<a href="'.base_url('admin/timeline_produksi/edit_retur/'.base64_encode($data->id_detail_timeline_produksi)).'" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>';
                    }
                ...
                <label>Daftar Bahan Produksi </label>
                  <table id="example3" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php 
                        $i_stok = 1;
                        foreach ($bahan_kemas as $val_stok) {
                      ?>
                        <tr>
                          <td style="text-align: center"><?php echo $i_stok ?></td>
                          <td style="text-align: center"><?php echo $val_stok->nama_bahan_kemas ?></td>
                          <td style="text-align: center"><?php echo $val_stok->qty_stok_pabrik ?></td>
                          <td style="text-align: center"><?php echo $val_stok->fix_sisa_stok_pabrik ?></td>
                          <td style="text-align: center"><?php echo $val_stok->terpakai_stok_pabrik + $val_stok->reject_stok_pabrik ?></td>
                          <td style="text-align: center"><?php echo $val_stok->qty_stok_pabrik - $val_stok->terpakai_stok_pabrik ?></td>
                          <td style="text-align: center"><?php echo $val_stok->reject_stok_pabrik ?></td>
                          <td style="text-align: center">
                            <a href="<?php echo base_url('admin/timeline_produksi/hapus_stok/'.base64_encode($val_stok->id_stok_pabrik).'/'.base64_encode($val_stok->no_timeline_produksi)) ?>" onClick="return confirm('Are you sure?');" class="btn btn-sm btn-danger"><i class="fa fa-trash-o"></i></a>
                          </td>
                        </tr>
                      <?php 
                          $i_stok++;
