            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group"><label>Start - End Date (*)</label>
                  <input type="text" name="periodik" class="form-control float-right" value="<?php echo $detail_timeline->start_date_detail_timeline_produksi.' - '.$detail_timeline->end_date_detail_timeline_produksi ?>" id="range-date">
                </div>
              </div>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <input type="text" oninput="checkValue(this);" min="1" max="<?php echo $row->selisih_po_produksi + $detail_timeline->qty_detail_timeline_produksi; ?>" name="dt_qty[]" value="<?php echo $detail_timeline->qty_detail_timeline_produksi; ?>">
                          </td>
                          <td> 
  ...
  <script type="text/javascript">
    ...
    $('#bahan-retur').click(function(e){
      ...
      if (nomor_po == '' && nomor_produksi == '' && keterangan == '' && sku == '' && dt_id == '' && dt_po == '' && dt_qty == '') {
        ...
        $.ajax({ 
          url:"<?php echo base_url()?>admin/timeline_produksi/retur_proses_edit",
          method:"post",
          dataType: 'JSON', 
          data:{id_detail: id_detail, nomor_po:nomor_po, nomor_produksi: nomor_produksi, keterangan: keterangan, qty: qty, sku: sku, date: date, dt_id: JS_id, dt_po: JS_po, dt_qty: JS_qty, length: panjangArray, [csrfName]: csrfHash},
