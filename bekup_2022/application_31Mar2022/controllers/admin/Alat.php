...
class Alat extends CI_Controller {
  ...
  //       )
        ...
        // // 			    $ocr = new TesseractOCR(base_url('uploads/ocr/'.$dataInfo[$i]['file_name']));
        // // 		        $ocr->executable('C:\Program Files\Tesseract-OCR\tesseract.exe');
        // // 		        $ocr->lang('eng');
        // // 				$content = $ocr->run();
        // // 				$dataOCR[] = $content;
        // // 			} else {
        // // 			    $ocr = new TesseractOCR('/home/brighty/public_html/uploads/ocr/'.$dataInfo[$i]['file_name']);
        // // 		        $ocr->lang('eng');
        // // 				$content = $ocr->run();
        // // 				$dataOCR[] = $content;
        // // 			}
        ...
        // // 			$dir        = "./uploads/ocr/".$dataInfo[$i]['file_name'];
        ...
        //     			// MENGAMBIL NILAI PENERIMA DAN NOMOR HP
    				...
    				// 	$store_nama_hp[] = explode(",", str_replace(array("Penerima : "), "", $pecahanOCR[$main][$child]));
