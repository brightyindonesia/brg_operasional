...
<div class="wrapper">
  ...
  <script type="text/javascript">
    $('#import-rfq').click(function(e){
      ...
      var imports = document.getElementById('impor_rfq');
      ...
      if(imports.files['length'] == 0){
        Toast.fire({
          icon: 'error',
          title: 'Terjadi Kesalahan!. File Import RFQ harus diisi!'
        });
      }else{
        var formData = new FormData();
        formData.append('impor_rfq', $('#impor_rfq')[0].files[0]);  
        ...
        $.ajax({ 
          url:"<?php echo base_url()?>admin/masuk/proses_import_rfq_new",
          method:"post",
          dataType: 'JSON', 
          ...
          success:function(data)  {  
            ...
            document.getElementById("impor_rfq").value = null;
            if (data.validasi) {
              $("#modal-proses").modal('hide');
              if (data.pesan_error) {
