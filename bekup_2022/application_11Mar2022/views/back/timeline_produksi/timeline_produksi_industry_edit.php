...
<div class="wrapper">
      ...
      <div class="box box-primary">
        ...
        ?>
                  ...
                  <label>Daftar Bahan Produksi</label>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            <input type="hidden" id="dr_stok[]" name="dr_stok[]" value="<?php echo $row_r->qty_detail_timeline_produksi ?>">
                            <input type="text" id="dr_qty[]" name="dr_qty[]" oninput="checkValue(this);" min="1" max="<?php echo $row_r->qty_detail_timeline_produksi ?>" value="<?php echo $row_r->qty_selisih_detail_timeline_produksi ?>">
                        </td>
                      </tr>
                      <?php
                          }
          ...
          <div class="box-footer">
            <button type="submit" id="bahan-industry-edit" name="button" class="btn btn-success"><i class="fa fa-save"></i> <?php echo $btn_submit ?></button>
  ...
  <script type="text/javascript">
    ...
    // submit form masuk
    $('#bahan-industry-edit').click(function(e){
      ...
      var dr_qty =  $("input[name='dr_qty[]']")
            .map(function(){return $(this).val();}).get();
      var dr_stok =  $("input[name='dr_stok[]']")
            .map(function(){return $(this).val();}).get();
      ...
      var JS_dr_stok = JSON.stringify(dr_stok);
      ...
      if (nomor_po == '' && nomor_produksi == '' && keterangan == '' && sku == '') {
        ...
        $.ajax({ 
          url:"<?php echo base_url()?>admin/timeline_produksi/proses_edit_industry",
          method:"post",
          dataType: 'JSON',
          data:{id_detail: id_detail,nomor_po:nomor_po, nomor_produksi: nomor_produksi, keterangan: keterangan, qty: qty, sku: sku, dr_id: JS_dr_id, dr_id_posi: JS_dr_id_posi, dr_id_detail: JS_dr_id_detail, dr_po: JS_dr_po, dr_qty: JS_dr_qty, dr_stok: JS_dr_stok, dr_terpakai: JS_dr_terpakai, dr_sisa: JS_dr_sisa, dr_selisih: JS_dr_selisih, length_dr: panjangArray_dr, date: date, [csrfName]: csrfHash},
