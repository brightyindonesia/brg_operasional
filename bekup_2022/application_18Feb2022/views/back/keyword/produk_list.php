...
<div class="wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <div class="box box-primary">
            <div class="box-header">
              <div class="row">
                ...
                <div class="col-sm-12">
                  <div class="form-group"><label>Upload File Impor Keyword Produk (*)</label>
                  ...
                  <div class="form-group">
                    ...
                    <a href="<?php echo $format_produk ?>" class="btn btn-info"><i class="fa fa-file-excel-o"></i> <?php echo $btn_import ?></a>
                  </div>
                </div>
                <?php echo form_close(); ?>
              </div>
        ...
        <div class="col-sm-9">
          <div class="box box-primary">
            <div class="box-header">
              <a href="<?php echo $add_action_produk ?>" class="btn btn-primary"><i class="fa fa-plus"></i> <?php echo $btn_add ?></a> 
              <a href="<?php echo $export_action_produk ?>" class="btn btn-success"><i class="fa fa-file-excel-o"></i> <?php echo $btn_export ?></a> 
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  ...
  $(document).ready( function () {
    ...
    function dasbor_list_count()
    {
        ...
        $.ajax({
                url:'<?php echo base_url()?>admin/keyword/dasbor_list_produk_count/',
                type: "post",
    ...
    $('#btn-delete-pilih').on('click', function(e) {
          ...
          {  
              ...
              if(check == true){  
                  ...
                  csrfHash = '<?php echo $this->security->get_csrf_hash(); ?>';
                  $.ajax({
                      url: "<?php echo base_url()?>admin/keyword/produk_hapus_dipilih",
                      type: 'POST',
                      dataType: 'JSON', 
    ...
    var table = $('#table-keyword').DataTable({
        ...
        "bAutoWidth": false,
        'ajax': {
            'url': '<?php echo base_url()?>admin/keyword/get_data_produk',
            'data': function(d){
              dasbor_list_count();
            }
        },
