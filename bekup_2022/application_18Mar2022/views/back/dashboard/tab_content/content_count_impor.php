  ...
  <div class="box-body">
    <div class="info-box">
      ...
      <div class="info-box-footer">
        <a href="javascript:void(0)" onclick="tabelDataPenjualan('semua', 'impor');" style="margin-left: 10px;">View Data <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    ...
    <div class="info-box">
      ...
      <div class="info-box-footer">
        <a href="javascript:void(0)" onclick="tabelDataPenjualan(1, 'impor');" style="margin-left: 10px;">View Data <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- /.info-box -->
    <div class="info-box">
      ...
      <div class="info-box-footer">
        <a href="javascript:void(0)" onclick="tabelDataPenjualan(2, 'impor');" style="margin-left: 10px;">View Data <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- /.info-box -->
    ...
    <div class="info-box">
      ...
      <div class="info-box-footer">
        <a href="javascript:void(0)" onclick="tabelDataPenjualan(3, 'impor');" style="margin-left: 10px;">View Data <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- /.info-box -->
     <div class="info-box">
        ...
        <div class="info-box-footer">
        <a href="javascript:void(0)" onclick="tabelDataPenjualan(4, 'impor');" style="margin-left: 10px;">View Data <i class="fa fa-arrow-circle-right"></i></a>
      </div>
      </div>
      <!-- /.info-box -->
  </div>
...
<div class="box no-border">
  ...
  <div class="box-body">
    <div class="info-box">
      ...
      <div class="info-box-footer">
        <a href="javascript:void(0)" onclick="tabelDataResi('semua', 'impor');" style="margin-left: 10px;">View Data <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    ...
    <div class="info-box">
      ...
      <div class="info-box-footer">
        <a href="javascript:void(0)" onclick="tabelDataResi(0, 'impor');" style="margin-left: 10px;">View Data <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- /.info-box -->
    ...
    <div class="info-box">
      ...
      <div class="info-box-footer">
        <a href="javascript:void(0)" onclick="tabelDataResi(1, 'impor');" style="margin-left: 10px;">View Data <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- /.info-box -->
    ...
    <div class="info-box">
      ...
      <div class="info-box-footer">
        <a href="javascript:void(0)" onclick="tabelDataResi(2, 'impor');" style="margin-left: 10px;">View Data <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- /.info-box -->
    ...
    <div class="info-box">
      ...
      <div class="info-box-footer">
        <a href="javascript:void(0)" onclick="tabelDataResi(3, 'impor');" style="margin-left: 10px;">View Data <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- /.info-box -->
  </div>
...
<div class="box no-border">
  ...
  <div class="box-body">
    <div class="info-box">
      ...
      <div class="info-box-footer">
        <a href="javascript:void(0)" onclick="tabelDataRetur('semua', 'impor');" style="margin-left: 10px;">View Data <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    ...
    <div class="info-box">
      ...
      <div class="info-box-footer">
        <a href="javascript:void(0)" onclick="tabelDataRetur(0, 'impor');" style="margin-left: 10px;">View Data <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- /.info-box -->
    ...
    <div class="info-box">
      ...
      <div class="info-box-footer">
        <a href="javascript:void(0)" onclick="tabelDataRetur(1, 'impor');" style="margin-left: 10px;">View Data <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- /.info-box -->
    ...
    <div class="info-box">
      ...
      <div class="info-box-footer">
        <a href="javascript:void(0)" onclick="tabelDataRetur('semua', 'impor', 1);" style="margin-left: 10px;">View Data <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- /.info-box -->
    ...
    <div class="info-box">
      ...
      <div class="info-box-footer">
        <a href="javascript:void(0)" onclick="tabelDataRetur('semua', 'impor', 0);" style="margin-left: 10px;">View Data <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- /.info-box -->
  </div>
