...
<div class="wrapper">
            ...
            <table id="datatable" class="table table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <th style="text-align: center">Nama Level Kasus</th>
  ...
  $(document).ready( function () {
    ...
    $('#btn-ekspor').click(function(){
      ...
      if(check == true){
        window.open("<?php echo base_url() ?>admin/level_kasus/export_level_kasus");
      }
    });
   ...
   $('#datatable').DataTable({
        ...
        "bAutoWidth": false,
        'ajax': {
            'url': '<?php echo base_url()?>admin/level_kasus/get_data_datatables'
        },
        'columns': [
            { data: "no"},
            { data: "nama"},
    ...
    $('#btn-delete-pilih').on('click', function(e) {
          ...
          {  
              ...
              if(check == true){  
                  ...
                  $.ajax({
                      url: "<?php echo base_url()?>admin/level_kasus/hapus_dipilih",
                      type: 'POST',
                      dataType: 'JSON', 
                      ...
                      success: function (data) {
                        ...
                        if (data.sukses) {
                          Toast.fire({
                            ...
                            window.location.replace("<?php echo base_url()?>admin/level_kasus");
                          });
                        }
                        // console.log(data);
                        // $(".sub_chk:checked").each(function() {  
