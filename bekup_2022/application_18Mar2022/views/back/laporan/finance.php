          ...
          <div class="box box-primary no-border">
            <div class="box-header">
              <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    <label>Data Omset Penjualan</label>
                    <button id="btn-data-omset" class="btn btn-sm btn-success form-control" style="float: right;"><i class="fa fa-file-excel-o" style="margin-right: 5px"></i> Cetak</button>
                  </div>
                </div>

                <div class="col-sm-4">
                  <div class="form-group">
                    <label>Data Margin Penjualan</label>
