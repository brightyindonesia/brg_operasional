  ...
  $(document).ready( function () {
    ...
    $('#btn-gabungin').click(function(){
      ...
      if(check == true){
        ...
        window.open("<?php echo base_url() ?>admin/laporan/export_gabungin/"+users+"/"+periodik,+"_self");
      }
    });
    ...
    $('#btn-google-contacts').click(function(){
      ...
      if(check == true){
        ...
        window.open("<?php echo base_url() ?>admin/laporan/export_google_contacts/"+users+"/"+periodik,+"_self");
      }
    });
  });
  </script>
