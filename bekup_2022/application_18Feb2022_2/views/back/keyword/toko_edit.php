...
<div class="wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-primary">
        ...
        ?>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group"><label>Nama Toko (*)</label>
                  <?php echo form_dropdown('toko', $get_all_toko, $toko->id_toko, $toko_nama); ?>
                </div>
              </div>
                ...
                <div class="form-group"><label>Keyword Toko: (*)</label>
                  <br>
                    <?php 
                        ...
                        echo form_input($keys_toko, $keys) 
                    ?>
                </div>
              </div>
            </div>
          ...
          <?php 
            echo form_input($id_keyword_toko, $toko->id_keyword_toko);
          ?>
  ...
  <script>
    ...
    $('#btn-simpan').click(function(e){
        ...
        var id = document.getElementById('id-keyword-toko').value;
        ...
        if (keys == '') {
          ...
          $.ajax({ 
              url:"<?php echo base_url()?>admin/keyword/toko_ubah_proses",
              method:"post",
              dataType: 'JSON', 
              data:{keys: keys, toko:toko, id:id, [csrfName]: csrfHash},
