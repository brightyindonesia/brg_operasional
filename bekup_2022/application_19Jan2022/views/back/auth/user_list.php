            ...
            <table id="dataTable" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php $no = 1; foreach($get_all as $user){
                  ...
                  else{$is_active = '<a href="'.base_url('admin/auth/activate/'.$user->id_users).'" class="btn btn-xs btn-danger">INACTIVE</a>';}
                  // action
                  $edit = '<a href="'.base_url('admin/auth/update/'.$user->id_users).'" class="btn btn-warning"><i class="fa fa-pencil"></i></a>';
                  $delete = '<a href="'.base_url('admin/auth/delete/'.$user->id_users).'" onClick="return confirm(\'Are you sure?\');" class="btn btn-danger"><i class="fa fa-trash"></i></a>';
                ?>
                  <tr>
