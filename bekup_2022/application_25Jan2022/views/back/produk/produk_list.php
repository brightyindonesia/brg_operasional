    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-header">
          ...
          <a href="<?php echo $sinkron_action ?>" class="btn btn-warning"><i class="fa fa-refresh"></i> <?php echo $btn_sinkron ?></a>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            ...
            <table id="datatable" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php $no = 1; foreach($get_all as $data){
                  // action
                  $generateHPP = '<a href="'.base_url('admin/produk/generatehpp/'.$data->id_produk).'" onClick="return confirm(\'Are you sure for Generate HPP ?\');" class="btn btn-sm btn-success"><i class="fa fa-money"></i></a>';
        ...
        <div class="box-footer">
          ...
          <button type="button" style="float: right;margin-right: 5px;" id="btn-sinkron-pilih" class="btn btn-sm btn-warning"><i class="fa fa-refresh"></i> Select Data to sync Data with Sales</button>
          <button type="button" style="float: right;margin-right: 5px;" id="btn-generate-pilih" class="btn btn-sm btn-success"><i class="fa fa-money"></i> Selected Data Generate HPP</button>
        </div>
      </div>
      <!-- /.box -->
    </section>
  ...
  $(document).ready(function () {
      ...
      $('#btn-generate-pilih').on('click', function(e) {
          ...
          {  
            ...
            var check = confirm("Are you sure you want to generate hpp this row?");  
            if(check == true){  
