...
<div class="wrapper">
                ...
                <table id="table-timeline" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th style="text-align: center">HPP Produk</th>
  ...
  function dasbor_list_count()
  {
      ...
      $.ajax({
              url:'<?php echo base_url()?>admin/timeline_produksi/dasbor_list_count_hpp_fix/',
              type: "post",
              data: {vendor: vendor, periodik: periodik, [csrfName]: csrfHash},
              dataType: 'JSON',
  ...
  var table = $('#table-timeline').DataTable({
        ...
        'serverSide': true,
        'ajax': {
            'url': '<?php echo base_url()?>admin/timeline_produksi/get_data_timeline_hpp_fix',
            'data': function(d){
              d.vendor = $('#vendor').val();
