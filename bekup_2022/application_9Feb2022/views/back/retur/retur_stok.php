                ...
                <div class="card-body">
                  <table width="100%" border="0" class="table table-bordered table-responsive">
                    <tr>
                      ...
                      <td>
                        <div>
                          <?php echo $produk_retur->nomor_retur ?>
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td width="1%">:</td>
                      <td>
                        <?php  echo form_input($id_produk_retur, $produk_retur->id_produk_retur); ?>
                        <div>
                          <?php echo $produk_retur->nomor_pesanan ?>
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <div>
                          <?php echo $produk_retur->nomor_resi ?>
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <div>
                          <?php echo $produk_retur->nama_kurir ?>
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <div>
                          <?php echo $produk_retur->nama_toko ?>
                        </div>
                      </td>
                    </tr>
                  </table>
                  ...
                  <table width="100%" border="0" class="table table-bordered table-responsive">
                    <tr>
                      ...
                      <td>
                        <div>
                          <?php echo $produk_retur->nama_penerima ?>
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <div>
                          <?php echo $produk_retur->alamat_penerima ?>
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <div>
                          <?php echo $produk_retur->kabupaten ?>
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <div>
                          <?php echo $produk_retur->provinsi ?>
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <div>
                          <?php echo $produk_retur->hp_penerima ?>
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <div>
                          <?php echo $produk_retur->keterangan_retur ?>
                        </div>
                      </td>
                    </tr>
                  </table>
                    ...
                    <table id="table-resi-retur" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td style="text-align: center"><?php echo $produk_retur->nama_produk ?></td>
                          <td style="text-align: center">
                            <input type="button" class="btn-increment-decrement" value="-" onclick="decrement_quantity(<?php echo $produk_retur->id_produk ?>)"> &nbsp;
                            <input type="hidden" id="input-quantity-max-<?php echo $produk_retur->id_produk ?>" class="input-quantity" value="<?php echo $produk_retur->qty_retur ?>" style="width: 60px;height: 23px;padding-left: 23px;">
                            <input type="hidden" name="produk" class="input-quantity" value="<?php echo $produk_retur->id_produk ?>" style="width: 60px;height: 23px;padding-left: 23px;">
                            <input type="text" id="input-quantity-<?php echo $produk_retur->id_produk ?>" name="qty" oninput="checkValue(this);" min="1" max="<?php echo $produk_retur->qty_retur ?>" class="input-quantity" value="<?php echo $produk_retur->qty_retur ?>" style="width: 60px;height: 23px;padding-left: 23px;"> &nbsp;
                            <input type="button" class="btn-increment-decrement" value="+" onclick="increment_quantity(<?php echo $produk_retur->id_produk ?>)"/> &nbsp;
                              
                          </td>
                          <td>
                            <?php echo $produk_retur->keterangan_produk_retur ?>
                          </td>
                        </tr>
                      </tbody>                      
                    </table>
