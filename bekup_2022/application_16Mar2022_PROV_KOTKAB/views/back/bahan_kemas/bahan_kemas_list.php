...
<div class="wrapper">
            ...
            <table id="datatable" class="table table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <th style="text-align: center">Nama Bahan Kemas</th>
              ...
              <tbody>
                <?php $no = 1; foreach($get_all as $data){
                  // action
                  $edit = '<a href="'.base_url('admin/bahan_kemas/ubah/'.$data->id_bahan_kemas).'" class="btn btn-sm btn-warning"><i class="fa fa-pencil"></i></a>';
                  $delete = '<a href="'.base_url('admin/bahan_kemas/hapus/'.$data->id_bahan_kemas).'" onClick="return confirm(\'Are you sure?\');" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>';
                ?>
                  <tr>
                    <td style="text-align: center"><?php echo $no++ ?></td>
                    <td style="text-align: center"><?php echo $data->kode_sku_bahan_kemas ?></td>
                    ...
                    <td style="text-align: center"><?php echo $data->qty_bahan_kemas ?></td>
                    <td style="text-align: center"><?php echo $edit ?> <?php echo $delete ?></td>
                    <td style="text-align: center">
                      <input type="checkbox" class="sub_chk" data-id="<?php echo $data->id_bahan_kemas ?>">
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
  ...
  $(document).ready( function () {
    ...
    $('#btn-ekspor').click(function(){
      ...
      if(check == true){
        window.open("<?php echo base_url() ?>admin/bahan_kemas/export_bahan_kemas");
      }
    });
    ...
    $('#btn-delete-pilih').on('click', function(e) {
          ...
          {  
              ...
              if(check == true){  
                  ...
                  $.ajax({
                      url: "<?php echo base_url()?>admin/bahan_kemas/hapus_dipilih",
                      type: 'POST',
                      dataType: 'JSON', 
                      ...
                      success: function (data) {
                        ...
                        if (data.sukses) {
                          Toast.fire({
                            ...
                            window.location.replace("<?php echo base_url()?>admin/bahan_kemas");
                          });
                        }
                        // console.log(data);
                        // $(".sub_chk:checked").each(function() {  
