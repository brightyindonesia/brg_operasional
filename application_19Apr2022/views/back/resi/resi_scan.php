...
<div class="wrapper">
      ...
      <div class="row">
        <div class="col-sm-3">
          ...
          <div class="info-box-footer">
            <a href="javascript:void(0)" onclick="tabelScanGudang('semua');" style="margin-left: 10px;">Click Me <i class="fa fa-eye"></i></a>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-sm-3">
              <div class="info-box">
                ...
                <div class="info-box-footer">
                  <a href="javascript:void(0)" onclick="tabelScanGudang(2);" style="margin-left: 10px;">Click Me <i class="fa fa-eye"></i></a>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-3">
              <div class="info-box">
                ...
                <div class="info-box-footer">
                  <a href="javascript:void(0)" onclick="tabelScanGudang(1);" style="margin-left: 10px;">Click Me <i class="fa fa-eye"></i></a>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-3">
              <div class="info-box">
                ...
                <div class="info-box-footer">
                  <a href="javascript:void(0)" onclick="tabelScanGudang(0);" style="margin-left: 10px;">Click Me <i class="fa fa-eye"></i></a>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-3">
              <div class="info-box">
                ...
                <div class="info-box-footer">
                  <a href="javascript:void(0)" onclick="tabelScanGudang(3);" style="margin-left: 10px;">Click Me <i class="fa fa-eye"></i></a>
                </div>
              </div>
            </div>
          </div>
  ...
  <script type="text/javascript">
    ...
    function tabelScanGudang(status) {
      if ($.fn.DataTable.isDataTable("#table-resi-harian")) {
        $('#table-resi-harian').DataTable().clear().destroy();
        $('#table-resi-harian').dataTable().fnDestroy();
      }
      ...
      $('#table-resi-harian').DataTable({
          ...
          "bAutoWidth": false,
          'ajax': {
              'url': '<?php echo base_url()?>admin/resi/get_data_gudang',
              'data': function(d){
                d.status = status;
              },
          },
    ...
    function dasbor_list_count()
    {
        ...
        $.ajax({
                url:'<?php echo base_url()?>admin/resi/dasbor_list_count_gudang/',
                type: "post",
    ...
    function cekResi() {
      ...
      var csrfName = '<?php echo $this->security->get_csrf_token_name(); ?>',
        csrfHash = '<?php echo $this->security->get_csrf_hash(); ?>';
      $.ajax({
            url: "<?php echo base_url()?>admin/resi/scan_proses",
            type: "post",
            ...
            success:function(data)  {  
              ...
              if (data.validasi) {
              ...
              }else if (data.validasi_check_pic) {
                Toast.fire({
                  icon: 'error',
                  title: 'Perhatian!',
                  text: data.validasi_check_pic
                })
              }else{
                // refresh_table();
                ...
                // })
                // .then(function(){
                //   window.location.replace("<?php echo base_url()?>admin/resi/scan");
                // });
              }
