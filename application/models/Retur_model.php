...
class Retur_model extends CI_Model
{
  ...
  private function _get_datatables_query_produk()
  {
    ...
    $this->db->where(array(
      "date_format(tgl_retur, '%Y-%m-%d') >="   => $start,
  ...
  private function _get_datatables_query_riwayat()
  {
    ...
    $this->db->where(array(
      "date_format(tgl_riwayat_retur, '%Y-%m-%d') >="   => $start,
  ...
  function get_datatable_all($kurir, $toko, $status, $start, $end, $followup)
  {
  ...
  function get_by_nomor_pesanan($nomor)
  {
    $this->db->where('retur.nomor_pesanan', $nomor);
    return $this->db->get($this->table)->result();
  }
  ...
  function get_datatable($status, $kurir, $toko, $first, $last)
  {
    ...
    // ));
    $this->db->where(array(
      "date_format(tgl_retur, '%Y-%m-%d') >="   => $first,
