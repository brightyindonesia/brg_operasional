...
class Kategori_rating extends CI_Controller {
	...
	public function tambah_proses()
	{
	    ...
	    else
	    {
	      ...
	      $msg = '<div class="alert alert-success">Data saved succesfully</div>';
	      // $msg .= '<div class="alert alert-success">Data saved succesfully 1</div>';
	      // $msg .= '<div class="alert alert-success">Data saved succesfully 2</div>';
	...
	function export_kategori_rating()
	{
		$data['title']	= "Export Data Kategori Rating_".date("Y_m_d");
		$data['kategori_rating']	= $this->Kategori_rating_model->get_all();
		...
		$sheet->setCellValue('A1', 'id_kategori_rating');
		$sheet->setCellValue('B1', 'nama_kategori_rating');

        // set Row
        $rowCount = 2;
        foreach ($data['kategori_rating'] as $list) {
        	// Nomor Pesanan
            ...
            $sheet->SetCellValue('A' . $rowCount, $list->id_kategori_rating);
            $sheet->SetCellValue('B' . $rowCount, $list->nama_kategori_rating);
