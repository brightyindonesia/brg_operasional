...
<head>
  ...
  <!-- TagsInput -->
  <link rel="stylesheet" href="<?php echo base_url('assets/plugins/') ?>tagsinput/tagsinput.css">
  <!-- DataTables -->
  ...
  <!-- <link href="<?php echo base_url('assets/plugins/') ?>kartik-v-bootstrap-fileinput/css/fileinput.css" media="all" rel="stylesheet" type="text/css"/>
  <link href="<?php echo base_url('assets/plugins/') ?>kartik-v-bootstrap-fileinput/themes/explorer-fas/theme.css" media="all" rel="stylesheet" type="text/css"/> -->
  ...
  <!-- Rating Bootstrap -->
  <link rel="stylesheet" href="<?php echo base_url('assets/plugins/') ?>rating-bootstrap/css/star-rating.css">
  <link rel="stylesheet" href="<?php echo base_url('assets/plugins/') ?>rating-bootstrap/themes/krajee-fa/theme.css" media="all" type="text/css"/>
  <link rel="stylesheet" href="<?php echo base_url('assets/plugins/') ?>rating-bootstrap/themes/krajee-svg/theme.css" media="all" type="text/css"/>
  <link rel="stylesheet" href="<?php echo base_url('assets/plugins/') ?>rating-bootstrap/themes/krajee-uni/theme.css" media="all" type="text/css"/>
  <!-- Favicon -->
  ...
  <style type="text/css">
    ...
    /*Details untuk Impor*/
    td.details-control-impor {
        background: url(<?php echo base_url('assets/images/plus.png') ?>) no-repeat center center;
        cursor: pointer;
    }
    tr.shown-impor td.details-control-impor {
        background: url(<?php echo base_url('assets/images/minus.png') ?>) no-repeat center center;
    }

    /*Details untuk Penjualan*/
    td.details-control-penjualan {
        background: url(<?php echo base_url('assets/images/plus.png') ?>) no-repeat center center;
        cursor: pointer;
    }
    tr.shown-penjualan td.details-control-penjualan {
        background: url(<?php echo base_url('assets/images/minus.png') ?>) no-repeat center center;
    }
