      ...
      <div class="row">
        <div class="col-sm-3">
          ...
          <div class="alert alert-warning">
            ...
            <p style="font-size: 16px">Pilih PIC terlebih dahulu. Sebelum Scan Resi!</p>
          </div>
          ...
          <div class="box box-primary no-border">
            <div class="box-body">
              ...
              <div class="form-group"><label>Pilih PIC</label>
  ...
  <script type="text/javascript">
    ...
    function cekResi() {
      ...
      if(pic == '') {
        Toast.fire({
          icon: 'error',
          title: 'Terjadi Kesalahan!. Nama PIC Resi harap dipilih!'
        });
      }else{
        $.ajax({
              url: "<?php echo base_url()?>admin/resi/tambah_proses",
              type: "post",
              data: {'resi': resi, 'pic': pic, [csrfName]: csrfHash},
              dataType: 'JSON',
              success:function(data)  {  
                // console.log(data);
                if (data.validasi) {
