      ...
      <div class="row">
        <div class="col-sm-3">
              ...
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <div class="form-group"><label>Status Follow Up</label>
                    <?php echo form_dropdown('followup', $get_all_followup, 'semua', $followup) ?>
                  </div>
          ...
          <div class="small-box bg-primary">
            <div class="inner">
              <h3 id="total-sudah-followup"></h3>

              <p>Sudah difollow up</p>
            </div>
            <div class="icon">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3 id="total-belum-followup"></h3>

              <p>Belum difollow up</p>
            </div>
            <div class="icon">
