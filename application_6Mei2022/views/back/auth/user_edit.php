            ...
            <div class="row">
              <div class="col-sm-4">
                <div class="form-group"><label>Current Data Access (*)</label>
                  <p>
                    <?php
                    $arr_access_ada = array();
                    if($get_all_data_access_old == NULL)
                    {
                      echo '<a class="btn btn-sm btn-danger">No Data</a>';
                    }
                    else
                    {
                      foreach($get_all_data_access_old as $data_access)
                      {
                        $string = chunk_split($data_access->data_access_name, 9, "</a> ");
                        echo '<a class="btn btn-sm btn-success">'.$string;
                        $arr_access_ada[] = $data_access->data_access_id;
                      }
                    }
                    ?>
                  </p>
              ...
              <div class="col-sm-4">
                <div class="form-group"><label>New Data Access (*)</label>
                  <?php echo form_dropdown('', $get_all_combobox_data_access, $arr_access_ada, $data_access_id) ?>
                </div>
              </div>
            </div>
          </div>
