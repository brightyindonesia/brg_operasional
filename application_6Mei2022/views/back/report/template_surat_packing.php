...
<html>
<head>
  <title>Surat Packing List</title>
  <style type="text/css">
    table {
...
<body>
  ...
  <table cellspacing="0" style="margin-top: 10px;" cellpadding="3" border="1" width="100%">
    ...
    <tr>
      ...
      <td align="center" style="font-size: 12px;">
        ...
        <?php echo number_format($row->jumlah_barang_surat_packing,null,",",".") ?>
      </td>
      <td align="center" style="font-size: 12px;">
