...
<div class="wrapper">
            ...
            <table id="datatable" class="table table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <th style="text-align: center">Nama Status Tiket</th>
  ...
  $(document).ready( function () {
    ...
    $('#btn-ekspor').click(function(){
      ...
      if(check == true){
        window.open("<?php echo base_url() ?>admin/status_tiket/export_status_tiket");
      }
    });
   ...
   $('#datatable').DataTable({
        ...
        "bAutoWidth": false,
        'ajax': {
            'url': '<?php echo base_url()?>admin/status_tiket/get_data_datatables'
        },
        'columns': [
            { data: "no"},
            { data: "nama"},
    ...
    $('#btn-delete-pilih').on('click', function(e) {
          ...
          {  
              ...
              if(check == true){  
                  ...
                  $.ajax({
                      url: "<?php echo base_url()?>admin/status_tiket/hapus_dipilih",
                      type: 'POST',
                      dataType: 'JSON', 
                      ...
                      success: function (data) {
                        ...
                        if (data.sukses) {
                          Toast.fire({
                            ...
                            window.location.replace("<?php echo base_url()?>admin/status_tiket");
                          });
                        }
                        // console.log(data);
                        // $(".sub_chk:checked").each(function() {  
