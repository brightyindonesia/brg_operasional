...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <?php 
        if ($this->session->userdata('usertype') != 12) {
      ?>
      <li class="<?php if(current_url() == base_url('shopee/dashboard')){echo "active";} ?> ">
        <a href="<?php echo base_url('admin/shopee/dashboard') ?>"><i class="fa fa-dashboard"></i> <span>Dashboard API Shopee</span></a>
      </li>
      <?php
        }
      ?>
      ...
      $this->db->where('filter_menu', 'Shopee');
      ...
      <li>
        <a href="<?php echo base_url('admin/shopee') ?>"><i class="fa fa-arrow-left"></i> <span>Back to Operasional</span></a>
      </li>
