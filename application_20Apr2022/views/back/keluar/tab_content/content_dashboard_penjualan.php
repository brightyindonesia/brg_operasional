          ...
          <div class="box no-border">
            <div class="col-sm-3">
              <div class="box-header">
                ...
                <div class="form-group">
                  <button class="btn btn-sm btn-danger" id="reset-gudang-penjualan"><i class="fa fa-reset"></i> Reset</button>
                </div>
              </div>
            </div>
          ...
          <div class="box no-border">
            <div class="col-sm-3">
              <div class="box-header">
                ...
                <div class="form-group">
                  <button class="btn btn-sm btn-danger" id="reset-toko-penjualan"><i class="fa fa-reset"></i> Reset</button>
                </div>
              </div>
            </div>
