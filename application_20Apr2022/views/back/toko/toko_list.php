...
<div class="wrapper">
                ...
                ?>
                  <tr>
                    ...
                    <td style="text-align: center">
                      <input type="checkbox" class="sub_chk" data-id="<?php echo $data->id_toko ?>">
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
  ...
  $(document).ready( function () {
    ...
    $('#btn-ekspor').click(function(){
      ...
      if(check == true){
        window.open("<?php echo base_url() ?>admin/toko/export_toko");
      }
    });
    ...
    $('#btn-delete-pilih').on('click', function(e) {
          ...
          {  
              ...
              if(check == true){  
                  ...
                  $.ajax({
                      url: "<?php echo base_url()?>admin/toko/hapus_dipilih",
                      type: 'POST',
                      dataType: 'JSON', 
                      ...
                      success: function (data) {
                        ...
                        if (data.sukses) {
                          Toast.fire({
                            ...
                            window.location.replace("<?php echo base_url()?>admin/toko");
                          });
                        }
                        // console.log(data);
                        // $(".sub_chk:checked").each(function() {  
