...
<div class="wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-primary">
        ...
        ?>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group"><label>Nama Kurir (*)</label>
                  <?php echo form_dropdown('kurir', $get_all_kurir, $kurir->id_kurir, $kurir_nama); ?>
                </div>
              </div>
                ...
                <div class="form-group"><label>Keyword Kurir: (*)</label>
                  <br>
                    <?php 
                        ...
                        echo form_input($keys_kurir, $keys) 
                    ?>
                </div>
              </div>
            </div>
          ...
          <?php 
            echo form_input($id_keyword_kurir, $kurir->id_keyword_kurir);
          ?>
  ...
  <script>
    ...
    $('#btn-simpan').click(function(e){
        ...
        var id = document.getElementById('id-keyword-kurir').value;
        ...
        if (keys == '') {
          ...
          $.ajax({ 
              url:"<?php echo base_url()?>admin/keyword/kurir_ubah_proses",
              method:"post",
              dataType: 'JSON', 
              data:{keys: keys, kurir:kurir, id:id, [csrfName]: csrfHash},
