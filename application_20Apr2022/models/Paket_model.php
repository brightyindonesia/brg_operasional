...
class Paket_model extends CI_Model {
  ...
  function get_pakduk_produk_by_produk($id)
  {
    ...
    $this->db->select('nama_produk, hpp_produk, harga_produk, qty_pakduk, sub_sku');
  ...
  function get_pakduk_produk_by_produk_by_paket($id)
  {
    $this->db->select('pakduk_data_access.id_produk as produk_utama');
    $this->db->select('nama_produk, hpp_produk, harga_produk, qty_pakduk, sub_sku');
    $this->db->join($this->table_produk, 'produk.id_produk = pakduk_data_access.id_produk');
    $this->db->where('pakduk_data_access.id_paket', $id);
    return $this->db->get($this->table_pakduk)->result();
  }
