...
<div class="wrapper">
      ...
      <div class="row">
        <div class="col-sm-3">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3 id="total-riwayat"></h3>

              <p>Total Riwayat Retur</p>
            </div>
            <div class="icon">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table id="table-produk-riwayat" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      <th style="text-align: center">#</th>
                      <th width="10%" style="text-align: center">No. Retur</th>
                      <th width="27%" style="text-align: center">Nama Produk</th>
                      <th style="text-align: center">Updated Qty Produk</th>
                      <th style="text-align: center">Updated Qty Retur</th>
  ...
  function refresh_table(){
      $('#table-produk-riwayat').DataTable().ajax.reload();
  }
  ...
  function dasbor_list_count()
    {
        ...
        $.ajax({
                url:'<?php echo base_url()?>admin/retur/dasbor_list_count_riwayat/',
                type: "post",
                ...
                if (data.validasi) {
                  ...
                  document.getElementById("total-riwayat").innerHTML=data.total;
                }
  ...
  $(document).ready( function () {
    ...
    var table = $('#table-produk-riwayat').DataTable({
          "iDisplayLength":50,
          'processing': true,
          'serverSide': true,
          'ajax': {
              'url': '<?php echo base_url()?>admin/retur/get_data_riwayat',
              'data': function(d){
                  d.kurir = $('#kurir').val();
                  d.toko = $('#toko').val();
    ...
    $('#table-produk-riwayat').on('click', 'td.details-control', function () {
