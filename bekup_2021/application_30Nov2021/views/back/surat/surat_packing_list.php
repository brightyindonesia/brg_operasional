...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-sm-9">
          <div class="box box-primary">
            <div class="box-header"><a href="<?php echo $add_action_pl ?>" class="btn btn-primary"><i class="fa fa-plus"></i> <?php echo $btn_add_pl ?></a> </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <table id="table-sj" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th style="text-align: center">Tanggal Surat Packing</th>
                      <th width="20%" style="text-align: center">No. Surat Packing</th>
                      <th style="text-align: center">Nama Surat Packing</th>
  ...
  function dasbor_list_count()
    {
        ...
        $.ajax({
                url:'<?php echo base_url()?>admin/surat/dasbor_list_count_packing',
                type: "post",
  ...
  $(document).ready( function () {
    ...
    var table = $('#table-sj').DataTable({
          ...
          "serverSide": true,
          'ajax': {
              'url': '<?php echo base_url()?>admin/surat/get_data_surat_packing',
              'data': function(d){
