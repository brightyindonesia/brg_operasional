    ...
    <section class="content">
      ...
      <div class="box box-primary">
            ...
            <div class="row">
              <div class="col-sm-12">
                  <div class="form-group"><label>Nama Paket</label>
                    <?php echo form_input($paket_nama) ?>
                  </div>
              </div>
            </div>
          ...
          <div class="box-footer">
            <button type="submit" id="paket_tambah" name="button" class="btn btn-success"><i class="fa fa-save"></i> <?php echo $btn_submit ?></button>
  ...
  <script type="text/javascript">
    ...
    $('#paket_tambah').click(function(e){
      ...
      if (nama == '' && dt_id == '' && dt_qty == '') {
        ...
        $.ajax({ 
          url:"<?php echo base_url()?>admin/paket/tambah_proses",
          method:"post",
          dataType: 'JSON', 
          data:{nama:nama, dt_id: JS_id, dt_qty: JS_qty, length: panjangArray, [csrfName]: csrfHash},
