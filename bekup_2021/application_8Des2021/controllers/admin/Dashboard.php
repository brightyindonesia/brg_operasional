...
class Dashboard extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array('Dashboard_model', 'Produk_model', 'Bahan_kemas_model', 'Toko_model', 'Vendor_model'));
  ...
  //   	echo json_encode($msg);
	...
	function dasbor_list_count_penjualan(){
		$data    = $this->Dashboard_model->get_dasbor_list_penjualan();
    	if (isset($data)) {	
        	$msg = array(	'pending'	=> $data->pending,
    ...
    function dasbor_list_count_resi(){
		$data    = $this->Dashboard_model->get_dasbor_list_resi();
    	if (isset($data)) {	
        	$msg = array(	'belum'		=> $data->belum,
			        		'sedang'	=> $data->sedang,
			        		'sudah'		=> $data->sudah,
			        		'retur'		=> $data->retur,
        			);
