  ...
  <div class="col-sm-4 fit-content">
    ...
    <div class="box box-success">
      <div class="box-header with-border">
        ...
        <a href="<?php echo base_url('admin/keluar/data_penjualan') ?>" class="btn btn-sm btn-primary btn-flat pull-right"><i class="fa fa-table" style="margin-right: 5px;"></i> More Data</a>
      </div>
      <!-- /.box-header -->
      <div class="box-body">
        <div class="info-box">
    ...
    <!-- DASBOR: STATUS Penjualan -->
    <div class="box box-success fit-content">
      <div class="box-header with-border">
        <h3 class="box-title">Jumlah Status Resi</h3>
        <a href="<?php echo base_url('admin/resi') ?>" class="btn btn-sm btn-primary btn-flat pull-right"><i class="fa fa-table" style="margin-right: 5px;"></i> More Data</a>
      </div>
      <!-- /.box-header -->
      <div class="box-body">
        <div class="info-box">
