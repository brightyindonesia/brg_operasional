                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>
                            ...
                            <input type="hidden" id="dt_harga_bahan[]" name="dt_harga_bahan[]" value="<?php echo $row->harga_po; ?>">
