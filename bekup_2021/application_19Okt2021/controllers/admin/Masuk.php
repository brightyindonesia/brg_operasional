        ...
        foreach ($list as $data) {
	          ...
	          $detail = '<table cellpadding="0" width="100%" cellspacing="0" class="table" border="0" style="padding-left:50px;">'.
			            '<tr>'.
			                ...
			                '<td width="1%">:</td>'.
			                '<td><a href='.base_url('admin/masuk/img_blob/'.base64_encode($data->no_po)).' target="_blank" class="btn btn-sm btn-success"><i class="fa fa-search" style="margin-right: 5px;"></i> Lihat Bukti Transfer</td>'.
			            '</tr>'.
			            '<tr>'.
			                '<td width="15%">Status</td>'.
			                '<td width="1%">:</td>'.
