        ...
        <div class="box-body">
          <div class="table-responsive">
            <table id="datatable" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php $no = 1; foreach($get_all_by_produksi as $data){
                  // action
                  $add = '<a href="'.base_url('admin/produksi/produksi_add/'.base64_encode($data->no_po)).'" class="btn btn-sm btn-success"><i class="fa fa-plus"></i></a>';
