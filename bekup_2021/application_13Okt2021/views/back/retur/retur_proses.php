                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="text-align: center">
                            ...
                            <input type="text" id="input-quantity-<?php echo $val->id_produk ?>" name="qty[]" class="input-quantity" value="<?php echo $val->qty ?>" style="width: 60px;height: 23px;padding-left: 23px;"> &nbsp;
