...
class Resi_model extends CI_Model {
  ...
  public $column_search = array('nomor_pesanan','nama_kurir', 'resi.nomor_resi'); //field yang diizin untuk pencarian 
  public $order_data = array('status' => 'asc'); // default order 

  // Admin
  public $column_order_admin = array(null, 'nomor_pesanan','nama_kurir', 'resi.nomor_resi'); //field yang ada di table user
  ...
  private function _get_datatables_query()
    {
      ...
      $this->db->select('*');
      $this->db->select('date_format(tgl_resi, "%d-%m-%Y") as tanggal');
      ...
      //                           "tgl_resi <="   => $last
      //                         ));
      $this->db->where( array(  "date_format(tgl_resi, '%Y-%m-%d') >="   => $start,
                                "date_format(tgl_resi, '%Y-%m-%d') <="   => $end
      ));
  }
