...
<div class="wrapper">
  ...
  <script type="text/javascript">
    ...
    function tabelDataRetur(status, tanggal, follup = null) {
    ...
    function dasbor_count_status_retur()
    {
        ...
        $.ajax({
                ...
                if (data.validasi) {
                  ...
                  document.getElementById("jumlah-sudah-follow-retur").innerHTML=data.belum_fu;
                  document.getElementById("jumlah-belum-follow-retur").innerHTML=data.sudah_fu;
                }
