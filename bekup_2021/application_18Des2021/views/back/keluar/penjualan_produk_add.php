        ...
        <div class="col-sm-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#shopee" data-toggle="tab">Shopee</a></li>
              <li><a href="#tokopedia" data-toggle="tab">Tokopedia</a></li>
              <li><a href="#tiktok" data-toggle="tab">Tiktok</a></li>
              <li><a href="#backup" data-toggle="tab">Backup Database</a></li>
            </ul>
            <div class="tab-content">
              <div class="active shopee tab-pane" id="shopee">
                <?php include('tab_content/content_import_shopee.php'); ?>                
              </div>

              <div class="tab-pane" id="tokopedia">
