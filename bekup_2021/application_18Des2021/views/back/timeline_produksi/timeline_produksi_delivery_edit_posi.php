                    ...
                    <label>Daftar Bahan Produksi Reject</label>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="hidden" style="width: 110px;text-align: center;" type="text" name="dr_terpakai[]" id="dr_terpakai<?php echo $i ?>" value="<?php echo $row_r->terpakai_detail_timeline_produksi ?>">
                            <?php echo $row_r->terpakai_detail_timeline_produksi ?>
                          </td>
                          <td>
                            <input style="width: 110px;text-align: center;" type="hidden" name="dr_sisa[]" id="dr_sisa<?php echo $i ?>" value="<?php echo $row_r->qty_selisih_detail_timeline_produksi ?>">
                            <?php echo $row_r->qty_selisih_detail_timeline_produksi ?>
                          </td>

                          <td>
                           <input type="text" style="width: 110px;text-align: center;" type="text" oninput="checkValue(this);calculate('dr_sisa<?php echo $i ?>', 'dr_sisa_fix<?php echo $i ?>', 'dr_selisih<?php echo $i ?>', 'td_selisih<?php echo $i ?>');" min="1" max="<?php echo $row_r->qty_selisih_detail_timeline_produksi ?>" name="dr_sisa_fix[]" id="dr_sisa_fix<?php echo $i ?>" value="<?php echo $row_r->sisa_detail_timeline_produksi ?>">

                          </td>
                          <td>
                            <input style="width: 110px;text-align: center;" type="hidden" name="dr_selisih[]" id="dr_selisih<?php echo $i ?>" value="<?php echo $row_r->selisih_detail_timeline_produksi ?>">
                            <div id="td_selisih<?php echo $i ?>">
                              <?php echo $row_r->selisih_detail_timeline_produksi ?>
                            </div>
