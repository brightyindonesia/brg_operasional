...
<div class="wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-primary">
          <div class="box-header">
            <a href="<?php echo base_url('admin/surat/surat_jalan_detail_hapus_all/'.base64_encode($cek_surat->no_surat_jalan)) ?> " onClick="return confirm('Are you sure?');" class="btn btn-md btn-danger"><i class="fa fa-trash" style="margin-right: 5px;"></i> Hapus Semua Data Detail Surat Jalan</a>

            <a href="<?php echo base_url('admin/surat/surat_jalan_print/'.base64_encode($cek_surat->no_surat_jalan)) ?>" class="btn btn-md btn-success"><i class="fa fa-print" style="margin-right: 5px;"></i> Print Surat Jalan</a>

          <a href="<?php echo base_url('admin/surat/surat_jalan_ekspor/'.base64_encode($cek_surat->no_surat_jalan)) ?>" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Export Data Surat Jalan</a> 
            ...
            <div class="row">
              <div class="col-sm-6">
                  ...
                  <div class="form-group"><label>Nama Surat Jalan (*)</label>
                    <?php echo form_input($nama_surat_jalan, $cek_surat->nama_surat_jalan) ?>
                  </div>

                  <div class="form-group"><label>Keterangan Surat Jalan</label>
                    <?php echo form_textarea($keterangan, $cek_surat->keterangan_surat_jalan) ?>
                  </div>
              </div>

              <div class="col-sm-6">
                  <div class="form-group"><label>Tanggal Surat Jalan (*)</label>
                    <input type="text" name="periodik" class="form-control float-right" value="<?php echo date('Y/m/d', strtotime($cek_surat->tgl_surat_jalan)) ?>" id="date">
                  </div>

                  <div class="form-group"><label>Kepada Penerima (*)</label>
                    <?php echo form_input($kepada_surat_jalan, $cek_surat->kepada_surat_jalan) ?>
                  </div>
                ...
                <div class="nav-tabs-custom bg-success">
                  ...
                  <div class="tab-content">
                    <div class="active manual tab-pane" id="manual">
                      <?php include('tab_content/content_manual_sj.php'); ?>                
                    </div>
                    <div class="import tab-pane" id="import"> 
                      <?php include('tab_content/content_import_sj.php'); ?>                
                    </div>               
                  </div>
                </div>
              </div>
                  ...
                  <div class="form-group">
                    <label>Daftar Barang</label>
                      ...
                      <tbody>
                        ...
                        ?>
                        <tr>
                            <td> <input type="hidden" id="dt_kode[]" name="dt_kode[]" value="<?php echo $val_bar->kode_barang_surat_jalan ?>"><?php echo $val_bar->kode_barang_surat_jalan ?></td>
                            <td> <input type="hidden" id="dt_nama[]" name="dt_nama[]" value="<?php echo $val_bar->nama_barang_surat_jalan ?>"><?php echo $val_bar->nama_barang_surat_jalan ?></td> 
                            <td> <input type="hidden" id="dt_qty[]" name="dt_qty[]" value="<?php echo $val_bar->jumlah_barang_surat_jalan ?>"><?php echo $val_bar->jumlah_barang_surat_jalan ?></td>
                            <td> <input type="hidden" id="dt_satuan[]" name="dt_satuan[]" value="<?php echo $val_bar->satuan_barang_surat_jalan ?>"><?php echo $val_bar->satuan_barang_surat_jalan ?></td>
                            <td> <input type="hidden" id="dt_keterangan[]" name="dt_keterangan[]" value="<?php echo $val_bar->keterangan_barang_surat_jalan ?>"><?php echo $val_bar->keterangan_barang_surat_jalan ?></td>
                            <td> 
                              <button  onclick="edit_detail_jalan(<?php echo $val_bar->id_detail_surat_jalan ?>)" class="btn btn-warning btn-sm" >Ubah</button> 
                            </td> 
                        </tr>
                        <?php
                          }
          ...
          <div class="box-footer">
            <button type="submit" id="surat_jalan_add" name="button" class="btn btn-success"><i class="fa fa-save"></i> <?php echo $btn_submit ?></button>
  ...
  <?php 
    include('modal/modal_ubah_detail_jalan.php');
  ?>
  ...
  <script type="text/javascript">
    ...
    $('#surat_jalan_add').click(function(e){
      ...
      var nomor_surat = document.getElementById('nomor-surat-jalan').value;
      var nama_surat = document.getElementById('nama-surat-jalan').value;
      var date = document.getElementById('date').value;
      var kepada_surat = document.getElementById('kepada-surat-jalan').value;
      ...
      if (nomor_surat == '' && nama_surat == '' && kepada_surat == '' && keterangan == '' && penerima == '' && dt_kode == '' && dt_nama == '' && dt_qty == '' && dt_satuan == '' && dt_keterangan == '') {
        ...
        $.ajax({ 
          url:"<?php echo base_url()?>admin/surat/proses_surat_jalan_ubah",
          method:"post",
          dataType: 'JSON', 
          ...
          success:function(data)  {  
            ...
            if (data.sukses) {
              Toast.fire({
                ...
                window.location.replace("<?php echo base_url()?>admin/surat/surat_jalan_ubah/"+data.nomor);
              });
            }
    ...
    function edit_detail_jalan(id) {
      $.getJSON('<?php echo base_url('admin/surat/get_by_id_jalan/') ?>'+id+'', function(data){
          if(data){
              $('#edit-id').val(data.id);
    ...
    $('#form-edit').submit(function(e){
        ...
        $.ajax({
            url:"<?php echo base_url()?>admin/surat/detail_surat_jalan_ubah",
            method:"POST",
            dataType: 'JSON',
    ...
    $('#importdata').click(function(e){
      ...
      var nomor_sj = document.getElementById('nomor-surat-jalan');
      ...
      if(import_data.files['length'] == 0){
        ...
        formData.append('nomor', $('#nomor-surat-jalan').val());      
        formData.append([csrfName], csrfHash); 

        $("#modal-proses").modal('show');
        $.ajax({ 
          url:"<?php echo base_url()?>admin/surat/proses_impor_sj",
          method:"post",
          dataType: 'JSON', 
